...
function Footer() {
    return (
        <footer className="shadow-md border-t border-gray-700 py-8" style={{ backgroundColor: '#00267B' }}>    
            <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
                <div className="text-gray-200 text-center md:text-left mb-4 md:mb-0">
                    ...
                    <p className="text-sm">© 2024 SalesLink. Todos los derechos reservados.</p>
                </div>
